...
export class WorkTypeDetailScreen extends Component {
    ...
    render() {
        ...
        const checkBoxItem = [
            {
                work_type: "ช่างประปา",
                service: ['ติดตั้ง รื้อถอน ระบบประปา', 'วางทางเดินท่อน้ำ', 'เช็คระบบประปา']
            },
            {
                work_type: "ช่างไฟฟ้า",
                service: ['ติดตั้งระบบโซลาเซลล์','เดินสายไฟ','ติดตั้งรื้อถอนระบบไฟฟ้า','ติดตั้งระบบโทรศัพท์ สายแลน']
            },
            {
                work_type: 'ช่างยนต์',
                service: ['ดูแลระบบเครื่องยนต์','ดูแลระบบไฟฟ้ารถยนต์','ตรวจเล็คสภาพ','เปลี่ยนถ่ายน้ำมันเครื่อง','เปลี่ยนยาง','เปลี่ยนแบต']
            }
        ]

        const tagsItem = ['ดูแลระบบรถยนต์','เปลี่ยนถ่ายน้ำมันเครื่อง','เปลี่ยนยางรถยนต์','ตรวจเช็คระยะ']
        ...
        return (
            <SafeAreaView style={styles.container}>
                <View style={{flexDirection:"row",alignItems:"center",
                    ...
                    <Text style={{fontSize:20,color:"#009ada",textAlign:"center",alignItems:"center"}}>เลือกรายละเอียดงาน</Text>
                </View>
                                ...
                                return (
                                    <View>
                                        <View key={index} style={styles.checkBox}>
                                            ...
                                            <Text style={styles.checkBoxText}> {value.work_type} </Text>
                                        </View>
                                        <View style={styles.underLine} />
                                        {
                                            value.service.map((service, key) => {
                                                return (
                ...
                <View style={styles.toolsContainer}>
                    <TouchableOpacity style={styles.nextButton} onPress={()=>this.props.navigation.navigate('selectLocation')}>
...
export default WorkTypeDetailScreen
