...
export class WorkTypeScreen extends Component {
    ...
    render() {
        ...
        const checkBoxItem = ['ทั้งหมด', 'ช่างประปา', 'ช่างไฟ', 'ช่างสี', 'ช่างยนต์', 'ช่างไม้', 'ช่างแกะสลัก', 'ช่างปูน', 'ช่างเทคนิค', 'ช่างอาคาร', 'ช่างแอร์', 'ช่างเชื่อม']
        ...
        return (
            <SafeAreaView style={styles.container}>
                <View style={{flexDirection:"row",alignItems:"center",
                    ...
                    <Text style={{fontSize:20,color:"#009ada",textAlign:"center",alignItems:"center"}}>เลือกประเภทงาน</Text>
                </View>
                ...
                <View style={styles.toolsContainer}>
                    <TouchableOpacity style={styles.nextButton} onPress={()=>this.props.navigation.navigate('WorkTypeDetailScreen')}>
